...
### CrossSelingGroupByEnum
<table><thead><th align="left">Value</th><th align="left">Description</th></thead><tbody><tr><td valign="top"><strong>PRODUCT</strong></td><td>It's the default behavior, it will group SKUs from the same product and bring only products. Limited by 12 products.</td></tr><tr><td valign="top"><strong>NONE</strong></td><td>Return all skus registered in the catalog for the recommendation.</td></tr></tbody></table>
