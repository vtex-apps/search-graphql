...
### SimilarProductsQuantityEnum
<table><thead><th align="left">Value</th><th align="left">Description</th></thead><tbody><tr><td valign="top"><strong>ALL_AVAILABLE</strong></td><td>Returns all similar products by setting "groupByProduct" param to `false`</td></tr><tr><td valign="top"><strong>DEFAULT</strong></td><td>Returns 12 similar products by default</td></tr></tbody></table>
